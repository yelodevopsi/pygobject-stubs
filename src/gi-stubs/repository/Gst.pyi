...
def debug_bin_to_dot_file(bin: Bin, details: DebugGraphDetails, file_name: str) -> None: ...
def debug_bin_to_dot_file_with_ts(bin: Bin, details: DebugGraphDetails, file_name: str) -> None: ...
...
def debug_log_default(category: DebugCategory, level: DebugLevel, file: str, function: str, line: int, object: Optional[GObject.Object], message: DebugMessage, user_data: None) -> None: ...
def debug_log_get_line(category: DebugCategory, level: DebugLevel, file: str, function: str, line: int, object: Optional[GObject.Object], message: DebugMessage) -> str: ...
def debug_log_id_literal(category: DebugCategory, level: DebugLevel, file: str, function: str, line: int, id: Optional[str], message_string: str) -> None: ...
def debug_log_literal(category: DebugCategory, level: DebugLevel, file: str, function: str, line: int, object: Optional[GObject.Object], message_string: str) -> None: ...
...
def meta_register(api: Type, impl: str, size: int, init_func: Callable[[Meta, None, Buffer], bool], free_func: Callable[[Meta, Buffer], None], transform_func: Callable[[Buffer, Meta, Buffer, int, None], bool]) -> MetaInfo: ...
def meta_register_custom(name: str, tags: Sequence[str], transform_func: Optional[Callable[..., bool]] = None, *user_data: Any) -> MetaInfo: ...
def mini_object_replace(newdata: Optional[MiniObject] = None) -> Tuple[bool, MiniObject]: ...
def mini_object_take(newdata: MiniObject) -> Tuple[bool, MiniObject]: ...
def pad_mode_get_name(mode: PadMode) -> str: ...
def param_spec_array(name: str, nick: str, blurb: str, element_spec: GObject.ParamSpec, flags: GObject.ParamFlags) -> GObject.ParamSpec: ...
def param_spec_fraction(name: str, nick: str, blurb: str, min_num: int, min_denom: int, max_num: int, max_denom: int, default_num: int, default_denom: int, flags: GObject.ParamFlags) -> Optional[GObject.ParamSpec]: ...
...
def parse_bin_from_description_full(bin_description: str, ghost_unlinked_pads: bool, context: Optional[ParseContext], flags: ParseFlags) -> Element: ...
def parse_error_quark() -> int: ...
def parse_launch(pipeline_description: str) -> Element: ...
def parse_launch_full(pipeline_description: str, context: Optional[ParseContext], flags: ParseFlags) -> Element: ...
def parse_launchv(argv: Sequence[str]) -> Element: ...
def parse_launchv_full(argv: Sequence[str], context: Optional[ParseContext], flags: ParseFlags) -> Element: ...
def plugin_error_quark() -> int: ...
def preset_get_app_dir() -> Optional[str]: ...
def preset_set_app_dir(app_dir: str) -> bool: ...
def protection_filter_systems_by_available_decryptors(system_identifiers: Sequence[str]) -> Optional[list[str]]: ...
...
def tracing_register_hook(tracer: Tracer, detail: str, func: Callable[[], None]) -> None: ...
def type_find_get_type() -> Type: ...
def type_find_register(plugin: Optional[Plugin], name: str, rank: int, func: Callable[..., None], extensions: Optional[str] = None, possible_caps: Optional[Caps] = None, *data: Any) -> bool: ...
...
def util_array_binary_search(array: None, num_elements: int, element_size: int, search_func: Callable[..., int], mode: SearchMode, search_data: None, *user_data: Any) -> None: ...
...
def value_deserialize_with_pspec(src: str, pspec: Optional[GObject.ParamSpec] = None) -> Tuple[bool, Any]: ...
...
def value_set_fraction_range_full(value: Any, numerator_start: int, denominator_start: int, numerator_end: int, denominator_end: int) -> None: ...
...
class Allocator(Object):
    ...
    def __init__(self, name: Optional[str] = ...,
                 parent: Object = ...): ...
    def alloc(self, size: int, params: Optional[AllocationParams] = None) -> Optional[Memory]: ...
    def do_alloc(self, size: int, params: Optional[AllocationParams] = None) -> Optional[Memory]: ...
...
class AllocatorClass(GObject.GPointer):
    ...
    alloc: Callable[[Optional[Allocator], int, Optional[AllocationParams]], Optional[Memory]] = ...
...
class Bin(Element, ChildProxy):
    ...
    def iterate_all_by_element_factory_name(self, factory_name: str) -> Optional[Iterator]: ...
...
class Buffer(GObject.GBoxed):
    ...
    def add_reference_timestamp_meta(self, reference: Caps, timestamp: int, duration: int) -> Optional[ReferenceTimestampMeta]: ...
    ...
    def copy_region(self, flags: BufferCopyFlags, offset: int, size: int) -> Optional[Buffer]: ...
    ...
    def foreach_meta(self, func: Callable[..., Tuple[bool, Meta]], *user_data: Any) -> bool: ...
    ...
    def get_reference_timestamp_meta(self, reference: Optional[Caps] = None) -> Optional[ReferenceTimestampMeta]: ...
    ...
    def new(cls) -> Buffer: ...
    @classmethod
    def new_allocate(cls, allocator: Optional[Allocator], size: int, params: Optional[AllocationParams] = None) -> Optional[Buffer]: ...
    @classmethod
...
class BufferList(GObject.GBoxed):
    ...
    def foreach(self, func: Callable[..., Tuple[bool, Buffer]], *user_data: Any) -> bool: ...
...
class BufferPool(Object):
    ...
    def __init__(self, name: Optional[str] = ...,
                 parent: Object = ...): ...
    def acquire_buffer(self, params: Optional[BufferPoolAcquireParams] = None) -> Tuple[FlowReturn, Buffer]: ...
    @staticmethod
    ...
    @staticmethod
    def config_set_allocator(config: Structure, allocator: Optional[Allocator] = None, params: Optional[AllocationParams] = None) -> None: ...
    @staticmethod
    def config_set_params(config: Structure, caps: Optional[Caps], size: int, min_buffers: int, max_buffers: int) -> None: ...
    @staticmethod
    def config_validate_params(config: Structure, caps: Optional[Caps], size: int, min_buffers: int, max_buffers: int) -> bool: ...
    def do_acquire_buffer(self, params: Optional[BufferPoolAcquireParams] = None) -> Tuple[FlowReturn, Buffer]: ...
    def do_alloc_buffer(self, params: Optional[BufferPoolAcquireParams] = None) -> Tuple[FlowReturn, Buffer]: ...
...
class BufferPoolClass(GObject.GPointer):
    ...
    acquire_buffer: Callable[[BufferPool, Optional[BufferPoolAcquireParams]], Tuple[FlowReturn, Buffer]] = ...
    alloc_buffer: Callable[[BufferPool, Optional[BufferPoolAcquireParams]], Tuple[FlowReturn, Buffer]] = ...
...
class Bus(Object):
    ...
    def add_watch(self, priority: int, func: Callable[..., bool], *user_data: Any) -> int: ...
    ...
    def set_flushing(self, flushing: bool) -> None: ...
    def set_sync_handler(self, func: Optional[Callable[..., BusSyncReply]] = None, *user_data: Any) -> None: ...
    def sync_signal_handler(self, message: Message, data: None) -> BusSyncReply: ...
    def timed_pop(self, timeout: int) -> Optional[Message]: ...
    def timed_pop_filtered(self, timeout: int, types: MessageType) -> Optional[Message]: ...
...
class Caps(GObject.GBoxed):
    ...
    def append_structure_full(self, structure: Structure, features: Optional[CapsFeatures] = None) -> None: ...
    def can_intersect(self, caps2: Caps) -> bool: ...
    def copy(self) -> Caps: ...
    def copy_nth(self, nth: int) -> Caps: ...
    def filter_and_map_in_place(self, func: Callable[..., bool], *user_data: Any) -> None: ...
    ...
    def is_subset_structure_full(self, structure: Structure, features: Optional[CapsFeatures] = None) -> bool: ...
    ...
    def merge_structure_full(self, structure: Structure, features: Optional[CapsFeatures] = None) -> Caps: ...
    @classmethod
    ...
    def set_features(self, index: int, features: Optional[CapsFeatures] = None) -> None: ...
...
class Clock(Object):
    ...
    def add_observation_unapplied(self, slave: int, master: int) -> Tuple[bool, float, int, int, int, int]: ...
    def adjust_unlocked(self, internal: int) -> int: ...
    def adjust_with_calibration(self, internal_target: int, cinternal: int, cexternal: int, cnum: int, cdenom: int) -> int: ...
    ...
    @staticmethod
    def id_wait_async(id: None, func: Callable[..., bool], *user_data: Any) -> ClockReturn: ...
    ...
    def unadjust_with_calibration(self, external_target: int, cinternal: int, cexternal: int, cnum: int, cdenom: int) -> int: ...
...
class ControlBinding(Object):
    ...
    def __init__(self, name: str = ...,
                 object: Object = ...,
                 parent: Object = ...): ...
    def do_get_g_value_array(self, timestamp: int, interval: int, values: Sequence[Any]) -> bool: ...
    def do_get_value(self, timestamp: int) -> Optional[Any]: ...
    def do_sync_values(self, object: Object, timestamp: int, last_sync: int) -> bool: ...
    def get_g_value_array(self, timestamp: int, interval: int, values: Sequence[Any]) -> bool: ...
...
class ControlSource(Object):
    ...
    def control_source_get_value_array(self, timestamp: int, interval: int, values: Sequence[float]) -> bool: ...
...
class DateTime(GObject.GBoxed):
    ...
    @classmethod
    def new(cls, tzoffset: float, year: int, month: int, day: int, hour: int, minute: int, seconds: float) -> Optional[DateTime]: ...
    @classmethod
    def new_from_g_date_time(cls, dt: Optional[GLib.DateTime] = None) -> Optional[DateTime]: ...
    @classmethod
    ...
    @classmethod
    def new_local_time(cls, year: int, month: int, day: int, hour: int, minute: int, seconds: float) -> Optional[DateTime]: ...
    @classmethod
...
class DeviceMonitor(Object):
    ...
    def __init__(self, show_all: bool = ...,
                 name: Optional[str] = ...,
                 parent: Object = ...): ...
    def add_filter(self, classes: Optional[str] = None, caps: Optional[Caps] = None) -> int: ...
...
class DeviceProvider(Object):
    ...
    @staticmethod
    def register(plugin: Optional[Plugin], name: str, rank: int, type: Type) -> bool: ...
...
class Element(Object):
    ...
    def add_property_deep_notify_watch(self, property_name: Optional[str], include_value: bool) -> int: ...
    def add_property_notify_watch(self, property_name: Optional[str], include_value: bool) -> int: ...
    def add_static_metadata(self, key: str, value: str) -> None: ...
    def add_static_pad_template(self, static_templ: StaticPadTemplate) -> None: ...
    def add_static_pad_template_with_gtype(self, static_templ: StaticPadTemplate, pad_type: Type) -> None: ...
    ...
    def do_request_new_pad(self, templ: PadTemplate, name: Optional[str] = None, caps: Optional[Caps] = None) -> Optional[Pad]: ...
    ...
    def get_compatible_pad(self, pad: Pad, caps: Optional[Caps] = None) -> Optional[Pad]: ...
    def get_compatible_pad_template(self, compattempl: PadTemplate) -> Optional[PadTemplate]: ...
    ...
    def link_pads(self, srcpadname: Optional[str], dest: Element, destpadname: Optional[str] = None) -> bool: ...
    def link_pads_filtered(self, srcpadname: Optional[str], dest: Element, destpadname: Optional[str] = None, filter: Optional[Caps] = None) -> bool: ...
    def link_pads_full(self, srcpadname: Optional[str], dest: Element, destpadname: Optional[str], flags: PadLinkCheck) -> bool: ...
    def lost_state(self) -> None: ...
    @staticmethod
    def make_from_uri(type: URIType, uri: str, elementname: Optional[str] = None) -> Element: ...
    def message_full(self, type: MessageType, domain: int, code: int, text: Optional[str], debug: Optional[str], file: str, function: str, line: int) -> None: ...
    def message_full_with_details(self, type: MessageType, domain: int, code: int, text: Optional[str], debug: Optional[str], file: str, function: str, line: int, structure: Structure) -> None: ...
    ...
    def request_pad(self, templ: PadTemplate, name: Optional[str] = None, caps: Optional[Caps] = None) -> Optional[Pad]: ...
    def request_pad_simple(self, name: str) -> Optional[Pad]: ...
    def seek(self, rate: float, format: Format, flags: SeekFlags, start_type: SeekType, start: int, stop_type: SeekType, stop: int) -> bool: ...
...
class ElementClass(GObject.GPointer):
    ...
    request_new_pad: Callable[[Element, PadTemplate, Optional[str], Optional[Caps]], Optional[Pad]] = ...
...
class ElementFactory(PluginFeature):
    ...
    def create_with_properties(self, names: Optional[Sequence[str]] = None, values: Optional[Sequence[Any]] = None) -> Optional[Element]: ...
    @staticmethod
    ...
    @staticmethod
    def list_filter(list: list[ElementFactory], caps: Caps, direction: PadDirection, subsetonly: bool) -> list[ElementFactory]: ...
    @staticmethod
    ...
    @staticmethod
    def make_with_properties(factoryname: str, names: Optional[Sequence[str]] = None, values: Optional[Sequence[Any]] = None) -> Optional[Element]: ...
...
class Event(GObject.GBoxed):
    ...
    @classmethod
    def new_seek(cls, rate: float, format: Format, flags: SeekFlags, start_type: SeekType, start: int, stop_type: SeekType, stop: int) -> Event: ...
    @classmethod
...
class GhostPad(ProxyPad):
    ...
    def __init__(self, direction: PadDirection = ...,
                 ...
                 parent: Object = ...): ...
    @staticmethod
    def activate_mode_default(pad: Pad, parent: Optional[Object], mode: PadMode, active: bool) -> bool: ...
    def construct(self) -> bool: ...
    def get_target(self) -> Optional[Pad]: ...
    @staticmethod
    def internal_activate_mode_default(pad: Pad, parent: Optional[Object], mode: PadMode, active: bool) -> bool: ...
    @classmethod
    def new(cls, name: Optional[str], target: Pad) -> GhostPad: ...
    @classmethod
    def new_from_template(cls, name: Optional[str], target: Pad, templ: PadTemplate) -> GhostPad: ...
    @classmethod
    def new_no_target(cls, name: Optional[str], dir: PadDirection) -> GhostPad: ...
    @classmethod
    def new_no_target_from_template(cls, name: Optional[str], templ: PadTemplate) -> GhostPad: ...
...
class Message(GObject.GBoxed):
    ...
    lock: GLib.Mutex = ...
    cond: GLib.Cond = ...
    def add_redirect_entry(self, location: str, tag_list: Optional[TagList] = None, entry_struct: Optional[Structure] = None) -> None: ...
    ...
    def has_name(self, name: str) -> bool: ...
    @classmethod
    def new_application(cls, src: Optional[Object], structure: Structure) -> Message: ...
    @classmethod
    ...
    @classmethod
    def new_clock_provide(cls, src: Optional[Object], clock: Clock, ready: bool) -> Message: ...
    @classmethod
    def new_custom(cls, type: MessageType, src: Optional[Object] = None, structure: Optional[Structure] = None) -> Message: ...
    @classmethod
    def new_device_added(cls, src: Optional[Object], device: Device) -> Message: ...
    @classmethod
    def new_device_changed(cls, src: Optional[Object], device: Device, changed_device: Device) -> Message: ...
    @classmethod
    ...
    @classmethod
    def new_error(cls, src: Optional[Object], error: GLib.Error, debug: str) -> Message: ...
    @classmethod
    def new_error_with_details(cls, src: Optional[Object], error: GLib.Error, debug: str, details: Optional[Structure] = None) -> Message: ...
    @classmethod
    def new_have_context(cls, src: Optional[Object], context: Context) -> Message: ...
    @classmethod
    def new_info(cls, src: Optional[Object], error: GLib.Error, debug: str) -> Message: ...
    @classmethod
    def new_info_with_details(cls, src: Optional[Object], error: GLib.Error, debug: str, details: Optional[Structure] = None) -> Message: ...
    @classmethod
    def new_instant_rate_request(cls, src: Optional[Object], rate_multiplier: float) -> Message: ...
    @classmethod
    ...
    @classmethod
    def new_progress(cls, src: Optional[Object], type: ProgressType, code: str, text: str) -> Message: ...
    @classmethod
    def new_property_notify(cls, src: Object, property_name: str, val: Optional[Any] = None) -> Message: ...
    @classmethod
    def new_qos(cls, src: Optional[Object], live: bool, running_time: int, stream_time: int, timestamp: int, duration: int) -> Message: ...
    @classmethod
    def new_redirect(cls, src: Optional[Object], location: str, tag_list: Optional[TagList] = None, entry_struct: Optional[Structure] = None) -> Message: ...
    @classmethod
    ...
    @classmethod
    def new_segment_done(cls, src: Optional[Object], format: Format, position: int) -> Message: ...
    @classmethod
    def new_segment_start(cls, src: Optional[Object], format: Format, position: int) -> Message: ...
    @classmethod
    def new_state_changed(cls, src: Optional[Object], oldstate: State, newstate: State, pending: State) -> Message: ...
    @classmethod
    def new_state_dirty(cls, src: Optional[Object] = None) -> Message: ...
    @classmethod
    def new_step_done(cls, src: Optional[Object], format: Format, amount: int, rate: float, flush: bool, intermediate: bool, duration: int, eos: bool) -> Message: ...
    @classmethod
    def new_step_start(cls, src: Optional[Object], active: bool, format: Format, amount: int, rate: float, flush: bool, intermediate: bool) -> Message: ...
    @classmethod
    def new_stream_collection(cls, src: Optional[Object], collection: StreamCollection) -> Message: ...
    @classmethod
    def new_stream_start(cls, src: Optional[Object] = None) -> Message: ...
    @classmethod
    def new_stream_status(cls, src: Optional[Object], type: StreamStatusType, owner: Element) -> Message: ...
    @classmethod
    def new_streams_selected(cls, src: Optional[Object], collection: StreamCollection) -> Message: ...
    @classmethod
    def new_structure_change(cls, src: Optional[Object], type: StructureChangeType, owner: Element, busy: bool) -> Message: ...
    @classmethod
    ...
    @classmethod
    def new_warning(cls, src: Optional[Object], error: GLib.Error, debug: str) -> Message: ...
    @classmethod
    def new_warning_with_details(cls, src: Optional[Object], error: GLib.Error, debug: str, details: Optional[Structure] = None) -> Message: ...
...
class Meta(GObject.GPointer):
    ...
    def get_seqnum(self) -> int: ...
    @staticmethod
    def register(api: Type, impl: str, size: int, init_func: Callable[[Meta, None, Buffer], bool], free_func: Callable[[Meta, Buffer], None], transform_func: Callable[[Buffer, Meta, Buffer, int, None], bool]) -> MetaInfo: ...
    @staticmethod
    def register_custom(name: str, tags: Sequence[str], transform_func: Optional[Callable[..., bool]] = None, *user_data: Any) -> MetaInfo: ...
...
class MiniObject(GObject.GBoxed):
    ...
    def set_qdata(self, quark: int, data: None, destroy: Callable[[None], None]) -> None: ...
...
class Object(GObject.InitiallyUnowned):
    ...
    @staticmethod
    def default_deep_notify(object: GObject.Object, orig: Object, pspec: GObject.ParamSpec, excluded_props: Optional[Sequence[str]] = None) -> None: ...
    ...
    def get_g_value_array(self, property_name: str, timestamp: int, interval: int, values: Sequence[Any]) -> bool: ...
...
class Pad(Object):
    ...
    def add_probe(self, mask: PadProbeType, callback: Callable[..., PadProbeReturn], *user_data: Any) -> int: ...
    ...
    def create_stream_id(self, parent: Element, stream_id: Optional[str] = None) -> str: ...
    ...
    def iterate_internal_links_default(self, parent: Optional[Object] = None) -> Optional[Iterator]: ...
    ...
    @classmethod
    def new_from_template(cls, templ: PadTemplate, name: Optional[str] = None) -> Pad: ...
    ...
    def send_event(self, event: Event) -> bool: ...
    def set_activate_function_full(self, activate: Callable[..., bool], *user_data: Any) -> None: ...
    def set_activatemode_function_full(self, activatemode: Callable[..., bool], *user_data: Any) -> None: ...
    def set_active(self, active: bool) -> bool: ...
    def set_chain_function_full(self, chain: Callable[..., FlowReturn], *user_data: Any) -> None: ...
    def set_chain_list_function_full(self, chainlist: Callable[..., FlowReturn], *user_data: Any) -> None: ...
    def set_element_private(self, priv: None) -> None: ...
    def set_event_full_function_full(self, event: Callable[..., FlowReturn], *user_data: Any) -> None: ...
    def set_event_function_full(self, event: Callable[..., bool], *user_data: Any) -> None: ...
    def set_getrange_function_full(self, get: Callable[..., FlowReturn], *user_data: Any) -> None: ...
    def set_iterate_internal_links_function_full(self, iterintlink: Callable[..., Iterator], *user_data: Any) -> None: ...
    def set_link_function_full(self, link: Callable[..., PadLinkReturn], *user_data: Any) -> None: ...
    def set_offset(self, offset: int) -> None: ...
    def set_query_function_full(self, query: Callable[..., bool], *user_data: Any) -> None: ...
    def set_unlink_function_full(self, unlink: Callable[..., None], *user_data: Any) -> None: ...
    def start_task(self, func: Callable[..., None], *user_data: Any) -> bool: ...
    def sticky_events_foreach(self, foreach_func: Callable[..., bool], *user_data: Any) -> None: ...
...
class PadTemplate(Object):
    ...
    @classmethod
    def new(cls, name_template: str, direction: PadDirection, presence: PadPresence, caps: Caps) -> Optional[PadTemplate]: ...
    @classmethod
    def new_from_static_pad_template_with_gtype(cls, pad_template: StaticPadTemplate, pad_type: Type) -> Optional[PadTemplate]: ...
    @classmethod
    def new_with_gtype(cls, name_template: str, direction: PadDirection, presence: PadPresence, caps: Caps, pad_type: Type) -> Optional[PadTemplate]: ...
...
class Plugin(Object):
    ...
    def __init__(self, name: Optional[str] = ...,
                 parent: Object = ...): ...
    def add_dependency(self, env_vars: Optional[Sequence[str]], paths: Optional[Sequence[str]], names: Optional[Sequence[str]], flags: PluginDependencyFlags) -> None: ...
    def add_dependency_simple(self, env_vars: Optional[str], paths: Optional[str], names: Optional[str], flags: PluginDependencyFlags) -> None: ...
    ...
    @staticmethod
    def register_static(major_version: int, minor_version: int, name: str, description: str, init_func: Callable[[Plugin], bool], version: str, license: str, source: str, package: str, origin: str) -> bool: ...
    @staticmethod
    def register_static_full(major_version: int, minor_version: int, name: str, description: str, init_full_func: Callable[..., bool], version: str, license: str, source: str, package: str, origin: str, *user_data: Any) -> bool: ...
...
class Promise(GObject.GBoxed):
    ...
    def new(cls) -> Promise: ...
    @classmethod
    def new_with_change_func(cls, func: Callable[..., None], *user_data: Any) -> Promise: ...
...
class ProxyPad(Pad):
    ...
    def __init__(self, direction: PadDirection = ...,
                 ...
                 parent: Object = ...): ...
    @staticmethod
    def chain_default(pad: Pad, parent: Optional[Object], buffer: Buffer) -> FlowReturn: ...
    @staticmethod
    def chain_list_default(pad: Pad, parent: Optional[Object], list: BufferList) -> FlowReturn: ...
    ...
    @staticmethod
    def iterate_internal_links_default(pad: Pad, parent: Optional[Object] = None) -> Optional[Iterator]: ...
...
class Query(GObject.GBoxed):
    ...
    mini_object: MiniObject = ...
    type: QueryType = ...
    def add_allocation_meta(self, api: Type, params: Optional[Structure] = None) -> None: ...
    def add_allocation_param(self, allocator: Optional[Allocator] = None, params: Optional[AllocationParams] = None) -> None: ...
    def add_allocation_pool(self, pool: Optional[BufferPool], size: int, min_buffers: int, max_buffers: int) -> None: ...
    ...
    @classmethod
    def new_custom(cls, type: QueryType, structure: Optional[Structure] = None) -> Query: ...
    @classmethod
    ...
    def set_nth_allocation_param(self, index: int, allocator: Optional[Allocator] = None, params: Optional[AllocationParams] = None) -> None: ...
    def set_nth_allocation_pool(self, index: int, pool: Optional[BufferPool], size: int, min_buffers: int, max_buffers: int) -> None: ...
...
class Registry(Object):
    ...
    def feature_filter(self, filter: Callable[..., bool], first: bool, *user_data: Any) -> list[PluginFeature]: ...
    ...
    def plugin_filter(self, filter: Callable[..., bool], first: bool, *user_data: Any) -> list[Plugin]: ...
...
class Sample(GObject.GBoxed):
    ...
    @classmethod
    def new(cls, buffer: Optional[Buffer] = None, caps: Optional[Caps] = None, segment: Optional[Segment] = None, info: Optional[Structure] = None) -> Sample: ...
...
class Segment(GObject.GBoxed):
    ...
    def do_seek(self, rate: float, format: Format, flags: SeekFlags, start_type: SeekType, start: int, stop_type: SeekType, stop: int) -> Tuple[bool, bool]: ...
    def free(self) -> None: ...
...
class Stream(Object):
    ...
    @classmethod
    def new(cls, stream_id: Optional[str], caps: Optional[Caps], type: StreamType, flags: StreamFlags) -> Stream: ...
...
class TagList(GObject.GBoxed):
    ...
    def merge(self, list2: Optional[TagList], mode: TagMergeMode) -> Optional[TagList]: ...
    def n_tags(self) -> int: ...
    @classmethod
...
class Task(Object):
    ...
    def set_enter_callback(self, enter_func: Callable[..., None], *user_data: Any) -> None: ...
    def set_leave_callback(self, leave_func: Callable[..., None], *user_data: Any) -> None: ...
...
class TypeFind(GObject.GPointer):
    ...
    @staticmethod
    def register(plugin: Optional[Plugin], name: str, rank: int, func: Callable[..., None], extensions: Optional[str] = None, possible_caps: Optional[Caps] = None, *data: Any) -> bool: ...
...
class Uri(GObject.GBoxed):
    ...
    @classmethod
    def new(cls, scheme: Optional[str], userinfo: Optional[str], host: Optional[str], port: int, path: Optional[str] = None, query: Optional[str] = None, fragment: Optional[str] = None) -> Uri: ...
    def new_with_base(self, scheme: Optional[str], userinfo: Optional[str], host: Optional[str], port: int, path: Optional[str] = None, query: Optional[str] = None, fragment: Optional[str] = None) -> Uri: ...
    ...
    def set_query_value(self, query_key: str, query_value: Optional[str] = None) -> bool: ...
