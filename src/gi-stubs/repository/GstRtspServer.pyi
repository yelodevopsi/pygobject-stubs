...
def rtsp_sdp_from_media(sdp: GstSdp.SDPMessage, info: SDPInfo, media: RTSPMedia) -> bool: ...
def rtsp_sdp_from_stream(sdp: GstSdp.SDPMessage, info: SDPInfo, stream: RTSPStream) -> bool: ...
def rtsp_sdp_make_media(sdp: GstSdp.SDPMessage, info: SDPInfo, stream: RTSPStream, caps: Gst.Caps, profile: GstRtsp.RTSPProfile) -> bool: ...
...
class RTSPAddressPool(GObject.Object):
    ...
    def acquire_address(self, flags: RTSPAddressFlags, n_ports: int) -> Optional[RTSPAddress]: ...
    ...
    def reserve_address(self, ip_address: str, port: int, n_ports: int, ttl: int) -> Tuple[RTSPAddressPoolResult, RTSPAddress]: ...
...
class RTSPAuth(GObject.Object):
    ...
    def do_accept_certificate(self, connection: Gio.TlsConnection, peer_cert: Gio.TlsCertificate, errors: Gio.TlsCertificateFlags) -> bool: ...
    ...
    def set_tls_certificate(self, cert: Optional[Gio.TlsCertificate] = None) -> None: ...
...
class RTSPAuthClass(GObject.GPointer):
    ...
    accept_certificate: Callable[[RTSPAuth, Gio.TlsConnection, Gio.TlsCertificate, Gio.TlsCertificateFlags], bool] = ...
    _gst_reserved: list[None] = ...
...
class RTSPClient(GObject.Object):
    ...
    _gst_reserved: list[None] = ...
    def __init__(self, drop_backlog: bool = ...,
                 mount_points: Optional[RTSPMountPoints] = ...,
                 post_session_timeout: int = ...,
                 session_pool: Optional[RTSPSessionPool] = ...): ...
    def attach(self, context: Optional[GLib.MainContext] = None) -> int: ...
    def close(self) -> None: ...
    def do_adjust_error_code(self, ctx: RTSPContext, code: GstRtsp.RTSPStatusCode) -> GstRtsp.RTSPStatusCode: ...
    def do_adjust_play_mode(self, context: RTSPContext, range: GstRtsp.RTSPTimeRange, flags: Gst.SeekFlags, rate: float, trickmode_interval: int, enable_rate_control: bool) -> GstRtsp.RTSPStatusCode: ...
    def do_adjust_play_response(self, context: RTSPContext) -> GstRtsp.RTSPStatusCode: ...
    ...
    def do_configure_client_media(self, media: RTSPMedia, stream: RTSPStream, ctx: RTSPContext) -> bool: ...
    def do_configure_client_transport(self, ctx: RTSPContext, ct: GstRtsp.RTSPTransport) -> bool: ...
    ...
    def do_handle_sdp(self, ctx: RTSPContext, media: RTSPMedia, sdp: GstSdp.SDPMessage) -> bool: ...
    ...
    def do_pre_get_parameter_request(self, ctx: RTSPContext) -> GstRtsp.RTSPStatusCode: ...
    ...
    def do_pre_set_parameter_request(self, ctx: RTSPContext) -> GstRtsp.RTSPStatusCode: ...
    ...
    def do_send_message(self, ctx: RTSPContext, response: GstRtsp.RTSPMessage) -> None: ...
    ...
    def do_tunnel_http_response(self, request: GstRtsp.RTSPMessage, response: GstRtsp.RTSPMessage) -> None: ...
    ...
    def send_message(self, session: Optional[RTSPSession], message: GstRtsp.RTSPMessage) -> GstRtsp.RTSPResult: ...
    def session_filter(self, func: Optional[Callable[..., RTSPFilterResult]] = None, *user_data: Any) -> list[RTSPSession]: ...
    ...
    def set_send_messages_func(self, func: Callable[..., bool], *user_data: Any) -> None: ...
...
class RTSPClientClass(GObject.GPointer):
    ...
    configure_client_media: Callable[[RTSPClient, RTSPMedia, RTSPStream, RTSPContext], bool] = ...
    configure_client_transport: Callable[[RTSPClient, RTSPContext, GstRtsp.RTSPTransport], bool] = ...
    ...
    adjust_play_mode: Callable[[RTSPClient, RTSPContext, GstRtsp.RTSPTimeRange, Gst.SeekFlags, float, int, bool], GstRtsp.RTSPStatusCode] = ...
    adjust_play_response: Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode] = ...
    ...
    tunnel_http_response: Callable[[RTSPClient, GstRtsp.RTSPMessage, GstRtsp.RTSPMessage], None] = ...
    send_message: Callable[[RTSPClient, RTSPContext, GstRtsp.RTSPMessage], None] = ...
    handle_sdp: Callable[[RTSPClient, RTSPContext, RTSPMedia, GstSdp.SDPMessage], bool] = ...
    ...
    pre_describe_request: Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode] = ...
    ...
    pre_teardown_request: Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode] = ...
    pre_set_parameter_request: Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode] = ...
    pre_get_parameter_request: Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode] = ...
    pre_announce_request: Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode] = ...
    pre_record_request: Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode] = ...
    adjust_error_code: Callable[[RTSPClient, RTSPContext, GstRtsp.RTSPStatusCode], GstRtsp.RTSPStatusCode] = ...
    _gst_reserved: list[None] = ...
...
class RTSPMedia(GObject.Object):
    ...
    _gst_reserved: list[None] = ...
    def __init__(self, bind_mcast_address: bool = ...,
                 buffer_size: int = ...,
                 clock: Optional[Gst.Clock] = ...,
                 dscp_qos: int = ...,
                 element: Gst.Element = ...,
    ...
    def complete_pipeline(self, transports: Sequence[GstRtsp.RTSPTransport]) -> bool: ...
    def create_stream(self, payloader: Gst.Element, pad: Gst.Pad) -> RTSPStream: ...
    def do_convert_range(self, range: GstRtsp.RTSPTimeRange, unit: GstRtsp.RTSPRangeUnit) -> bool: ...
    ...
    def get_range_string(self, play: bool, unit: GstRtsp.RTSPRangeUnit) -> Optional[str]: ...
    ...
    def get_time_provider(self, address: Optional[str], port: int) -> Optional[GstNet.NetTimeProvider]: ...
    ...
    def seek_trickmode(self, range: GstRtsp.RTSPTimeRange, flags: Gst.SeekFlags, rate: float, trickmode_interval: int) -> bool: ...
    ...
    def set_permissions(self, permissions: Optional[RTSPPermissions] = None) -> None: ...
    ...
    def set_state(self, state: Gst.State, transports: Sequence[RTSPStreamTransport]) -> bool: ...
...
class RTSPMediaClass(GObject.GPointer):
    ...
    convert_range: Callable[[RTSPMedia, GstRtsp.RTSPTimeRange, GstRtsp.RTSPRangeUnit], bool] = ...
...
class RTSPMediaFactoryClass(GObject.GPointer):
    ...
    create_element: Callable[[RTSPMediaFactory, GstRtsp.RTSPUrl], Optional[Gst.Element]] = ...
...
class RTSPServer(GObject.Object):
    ...
    def __init__(self, address: str = ...,
                 ...
                 session_pool: Optional[RTSPSessionPool] = ...): ...
    def attach(self, context: Optional[GLib.MainContext] = None) -> int: ...
    def client_filter(self, func: Optional[Callable[..., RTSPFilterResult]] = None, *user_data: Any) -> list[RTSPClient]: ...
    def create_socket(self, cancellable: Optional[Gio.Cancellable] = None) -> Gio.Socket: ...
    def create_source(self, cancellable: Optional[Gio.Cancellable] = None) -> GLib.Source: ...
    ...
    def set_session_pool(self, pool: Optional[RTSPSessionPool] = None) -> None: ...
    def set_thread_pool(self, pool: Optional[RTSPThreadPool] = None) -> None: ...
    def transfer_connection(self, socket: Gio.Socket, ip: str, port: int, initial_buffer: Optional[str] = None) -> bool: ...
...
class RTSPSession(GObject.Object):
    ...
    _gst_reserved: list[None] = ...
    def __init__(self, extra_timeout: int = ...,
                 sessionid: str = ...,
                 timeout: int = ...,
                 timeout_always_visible: bool = ...): ...
    def allow_expire(self) -> None: ...
    def dup_media(self, path: str) -> Tuple[Optional[RTSPSessionMedia], int]: ...
    def filter(self, func: Optional[Callable[..., RTSPFilterResult]] = None, *user_data: Any) -> list[RTSPSessionMedia]: ...
...
class RTSPSessionPool(GObject.Object):
    ...
    def filter(self, func: Optional[Callable[..., RTSPFilterResult]] = None, *user_data: Any) -> list[RTSPSession]: ...
...
class RTSPStream(GObject.Object):
    ...
    _gst_reserved: list[None] = ...
    def __init__(self, control: Optional[str] = ...,
                 profiles: GstRtsp.RTSPProfile = ...,
                 protocols: GstRtsp.RTSPLowerTrans = ...): ...
    def add_multicast_client_address(self, destination: str, rtp_port: int, rtcp_port: int, family: Gio.SocketFamily) -> bool: ...
    def add_transport(self, trans: RTSPStreamTransport) -> bool: ...
    def allocate_udp_sockets(self, family: Gio.SocketFamily, transport: GstRtsp.RTSPTransport, use_client_settings: bool) -> bool: ...
    ...
    def get_multicast_address(self, family: Gio.SocketFamily) -> Optional[RTSPAddress]: ...
    ...
    def get_retransmission_time(self) -> int: ...
    def get_rtcp_multicast_socket(self, family: Gio.SocketFamily) -> Optional[Gio.Socket]: ...
    def get_rtcp_socket(self, family: Gio.SocketFamily) -> Optional[Gio.Socket]: ...
    def get_rtp_multicast_socket(self, family: Gio.SocketFamily) -> Optional[Gio.Socket]: ...
    ...
    def request_ulpfec_decoder(self, rtpbin: Gst.Element, sessid: int) -> Optional[Gst.Element]: ...
    def request_ulpfec_encoder(self, sessid: int) -> Optional[Gst.Element]: ...
    def reserve_address(self, address: str, port: int, n_ports: int, ttl: int) -> Optional[RTSPAddress]: ...
    ...
    def transport_filter(self, func: Optional[Callable[..., RTSPFilterResult]] = None, *user_data: Any) -> list[RTSPStreamTransport]: ...
...
class RTSPStreamTransport(GObject.Object):
    ...
    @classmethod
    def new(cls, stream: RTSPStream, tr: GstRtsp.RTSPTransport) -> RTSPStreamTransport: ...
    ...
    def set_callbacks(self, send_rtp: Callable[..., bool], send_rtcp: Callable[..., bool], *user_data: Any) -> None: ...
    def set_keepalive(self, keep_alive: Callable[..., None], *user_data: Any) -> None: ...
    def set_list_callbacks(self, send_rtp_list: Callable[..., bool], send_rtcp_list: Callable[..., bool], *user_data: Any) -> None: ...
    def set_message_sent(self, message_sent: Callable[..., None], *user_data: Any) -> None: ...
    def set_message_sent_full(self, message_sent: Callable[..., None], *user_data: Any) -> None: ...
...
class RTSPThreadPool(GObject.Object):
    ...
    def do_get_thread(self, type: RTSPThreadType, ctx: RTSPContext) -> Optional[RTSPThread]: ...
    def do_thread_enter(self, thread: RTSPThread) -> None: ...
    def do_thread_leave(self, thread: RTSPThread) -> None: ...
    def get_max_threads(self) -> int: ...
    def get_thread(self, type: RTSPThreadType, ctx: RTSPContext) -> Optional[RTSPThread]: ...
    @classmethod
...
class RTSPThreadPoolClass(GObject.GPointer):
    ...
    get_thread: Callable[[RTSPThreadPool, RTSPThreadType, RTSPContext], Optional[RTSPThread]] = ...
